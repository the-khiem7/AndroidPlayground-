...
import com.example.demodatabase.ui.product.adapter.AddToCartSheet;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    private com.example.demodatabase.data.model.Product current;
        ...
        if (toolbar != null) {
            ...
            toolbar.setOnMenuItemClickListener(item -> {
                if (item.getItemId() == R.id.action_cart) {
                    startActivity(new Intent(this, com.example.demodatabase.ui.cart.CartActivity.class));
                    return true;
                }
                return false;
            });
    ...
    private void loadDetail(int id) {
        ...
        com.example.demodatabase.data.mock.MockApiWrapper.getProduct(id).enqueue(new Callback<com.example.demodatabase.data.model.Product>() {
            @Override
            public void onResponse(Call<com.example.demodatabase.data.model.Product> call, Response<com.example.demodatabase.data.model.Product> res) {
                showLoading(false);
            ...
            @Override
            public void onFailure(Call<com.example.demodatabase.data.model.Product> call, Throwable t) {
                showLoading(false);
    ...
    private void bind(com.example.demodatabase.data.model.Product p) {
        if (p == null) {
