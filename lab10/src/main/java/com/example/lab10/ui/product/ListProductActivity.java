...
import com.example.lab10.ui.cart.CartActivity;
import com.example.lab10.ui.product.adapter.ProductAdapter;
...
public class ListProductActivity extends AppCompatActivity {
    ...
    private void loadProducts() {
        ...
        new Thread(() -> {
            ...
            if (!cached.isEmpty()) {
                runOnUiThread(() -> {
                    ...
                    List<com.example.lab10.data.model.Product> products = convertToProducts(cached);
        ...
        com.example.lab10.data.mock.MockApiWrapper.getProducts().enqueue(new Callback<List<com.example.lab10.data.model.Product>>() {
            @Override
            public void onResponse(@NonNull Call<List<com.example.lab10.data.model.Product>> call,
                                   @NonNull Response<List<com.example.lab10.data.model.Product>> resp) {
                progress.setVisibility(View.GONE);
                Log.d(TAG, "onResponse code=" + resp.code());

                if (resp.isSuccessful() && resp.body() != null) {
                    List<com.example.lab10.data.model.Product> items = resp.body();
            ...
            @Override
            public void onFailure(@NonNull Call<List<com.example.lab10.data.model.Product>> call, @NonNull Throwable t) {
                progress.setVisibility(View.GONE);
    ...
    private List<Product> convertToEntities(List<com.example.lab10.data.model.Product> products) {
        List<Product> entities = new ArrayList<>();
        for (com.example.lab10.data.model.Product p : products) {
    ...
    private List<com.example.lab10.data.model.Product> convertToProducts(List<Product> entities) {
        List<com.example.lab10.data.model.Product> products = new ArrayList<>();
