...
import com.example.lab10.data.remote.AuthApi;
import com.example.lab10.data.remote.CartApi;
import com.example.lab10.data.remote.ProductApi;
...
public class MockApiWrapper {
    ...
    public static Call<String> login(LoginRequest request) {
        if (MockDataProvider.USE_MOCK_DATA) {
            ...
            com.example.lab10.room.entity.User user =
